...
<body>
  ...
  <header class="main_menu">
    ...
    <div id="qnaRegi">
    	...
    	<form action="insert.do?mode=${mode }&type=notice&page=${pageData}" name="noticeFrm" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
    		<table>
    			...
    			<tr>
    				...
    				<td>
    					<input type="text" name="title" size="93" value="${ snb ne null?snb.ntitle:''}">
    				</td>
    			</tr>
    			<tr>
    				<td>
    				...
    				<td>
    					<textarea id="txtarea" name="contents">${ snb ne null?snb.ncontents:''}</textarea>
    				</td>
    			</tr>
				    	...
				    	<input type="hidden" name="no" value="${ snb ne null?snb.nno:''}">
    		<div id="btnDiv">
