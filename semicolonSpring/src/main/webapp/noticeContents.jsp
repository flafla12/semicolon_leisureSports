 ...
 <header class="main_menu">
    ...
    <div class="contents">
    	<div class="btnGroup">
    		...
    		<button class="back"><a id="aback" href="communityList.do?type=notice&no=${no }&page=${pageData}">목록</a></button>
    		
    		<c:if test="${(snb.id eq id) or (id eq 'admin')}">
    		<button class="mod"><a id="aedit" href="noticeForm.do?type=notice&mode=modify&page=${pageData}&no=${no}">수정</a></button>
    		<button class="del"><a id="adelete" href="delete.do?type=notice&no=${no}">삭제</a></button>
    		</c:if>
    	</div>
    	</div>
    	<div>
